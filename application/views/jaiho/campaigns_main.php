...
<head>
    ...
    <link href="<?php echo base_url('theme/inspinia/css/plugins/jsTree/style.min.css');?>" rel="stylesheet">

    <link href="<?php echo base_url('css/jaiho.css');?>" rel="stylesheet" />
    <!-- Essential -->
...
<body>
    ...
    <script src="<?php echo base_url('theme/inspinia/js/plugins/jsTree/jstree.min.js');?>"></script>
