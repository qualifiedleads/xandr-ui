# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-04-02 06:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('rtb', '0167_auto_20170402_0547'),
    ]

    operations = [
        migrations.CreateModel(
            name='PlacementStateHistory',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('rule_id', models.IntegerField(db_index=True, null=True)),
                ('rule_index', models.IntegerField(db_index=True, null=True)),
                ('spent', models.DecimalField(blank=True, db_index=True, decimal_places=10, max_digits=35, null=True)),
                ('conversions', models.IntegerField(db_index=True, null=True)),
                ('imps', models.IntegerField(db_index=True, null=True)),
                ('clicks', models.IntegerField(db_index=True, null=True)),
