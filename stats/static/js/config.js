...
function config($stateProvider, $resourceProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        ...
        .state('campaigns.single', {
            url: "/single",
            templateUrl: "views/stats/campaigns-single.html",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('dashboard.optimiser', {
            url: "/optimiser",
            templateUrl: "views/stats/optimiser.html",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('dashboard.billing', {
            url: "/billing",
            templateUrl: "views/stats/billing.html",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
